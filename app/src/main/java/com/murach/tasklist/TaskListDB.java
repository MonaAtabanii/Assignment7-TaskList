...
public class TaskListDB {
    ...
    private static class DBHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            // insert sample tasks
            db.execSQL("INSERT INTO task VALUES (1, 3, 'Complete the Assignments', " +
                    "'ITC162\nITC255\nITC155\nITC172 - Final Project', '0', '0')");
            db.execSQL("INSERT INTO task VALUES (2, 3, 'Read more about Android Dev.', " +
                    "'', '0', '0')");
        }
